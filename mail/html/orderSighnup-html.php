...
<div class="">
    ...
    <p>Ви зробили замовлення на сайті <?= Html::a(Yii::$app->name, Url::base(TRUE)) ?></p>
    ...
    <table class="table">
        <?php foreach ($order->order->cartItems as $item) { ?>
            <tr>
                ...
                <td>
                    <label><?= Html::a(Html::encode($item->item->title), Url::to(['/site/view', 'id' => $item->item->id], true)) ?></label>
                </td>
                <td>
